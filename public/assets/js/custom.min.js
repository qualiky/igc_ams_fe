var W3Crm = (function () {
  ...
  $(window).height();
  var e = function () {
      jQuery("select.nice-select").length > 0 &&
        (jQuery("select.nice-select").niceSelect(),
        document.querySelectorAll("select.nice-select").forEach((t, e) => {
          var a = [];
          jQuery(t)
            .parents()
            .map((e, n) => {
              ("hidden" === jQuery(jQuery(t).parents()[e]).css("overflow-x") ||
                "auto" === jQuery(jQuery(t).parents()[e]).css("overflow-x") ||
                "auto" === jQuery(jQuery(t).parents()[e]).css("overflow") ||
                "hidden" === jQuery(jQuery(t).parents()[e]).css("overflow") ||
                "hidden" === jQuery(jQuery(t).parents()[e]).css("overflow-y") ||
                "auto" === jQuery(jQuery(t).parents()[e]).css("overflow-y")) &&
                a.push(jQuery(t).parents()[e]);
            }),
            jQuery(a[0]).height() <
              jQuery(t).offset().top -
                jQuery(a[0]).offset()?.top +
                jQuery(t).next().height() +
                10 +
                jQuery(t).next().find("ul.list").height() &&
              jQuery(t).addClass("dropUp");
        }),
        $(".status-select").on("change", function () {
          $(this).removeClass(
            "status-complete status-pending status-testing status-progress status-high status-low status-medium"
          );
          var t = $(this).val();
          "pending" === t
            ...
            : "low" === t && $(this).addClass("status-low"),
            $(this).niceSelect("update");
        }));
    },
    a = function () {
      jQuery(".calendar-container").length > 0 &&
    ...
    s = function () {
      jQuery("#menu").length > 0 && $("#menu").metisMenu(),
        jQuery(".metismenu > .mmm-active ").each(function () {
    ...
    i = function () {
      function t(t, e) {
        ...
        return (
          s.appendChild(t.cloneNode(!1)),
          (a = s.innerHTML),
          e &&
            ((n = a.indexOf(">") + 1),
            (a = a.substring(0, n) + t.innerHTML + a.substring(n))),
          (s = null),
          a
        );
      }
      $(".svg-btn").on("click", function () {
        ...
        $("#svg_img_Brassieresvg").find(".modal-title").text(t),
          $(".iconValue").text('<img src="images/iconly/light/' + t + '"/>');
      }),
        $(".img-btn").on("click", function () {
          var t = $(this)
            .closest(".svg-icons-ov")
            .find(".svg-classname")
            .text();
          $("#svg_img_Brassieresvg").find(".modal-title").text(t);
          var e,
            ...
            s =
              ((e = $(this)
                .closest(".svg-icons-ov")
                .find(".svg-icons-prev")[0].innerHTML),
    ...
    c = function () {
      $(".nav-control").on("click", function () {
        $("#main-wrapper").toggleClass("menu-toggle"),
          ...
          $("#sidebarMain").toggleClass("left-roshan"),
          r();
      });
    },
    l = function () {
      for (
        ...
        e = e.parent().addClass("mm-show").parent().addClass("mmm-active");
    },
    d = function () {
    ...
    r = function () {
      ...
      (t > 0 ? t : screen.height) &&
        ...
        setTimeout(() => {
          "vertical" === $("body").attr("data-layout") &&
            (("mini" === $("body").attr("data-sidebar-style") &&
              $(".deznav .metismenu").height() > window.innerHeight - 60) ||
              ("modern" === $("body").attr("data-sidebar-style") &&
                $(".deznav .metismenu").height() > window.innerHeight - 60) ||
              ("full" === $("body").attr("data-sidebar-style") &&
                $("#main-wrapper").hasClass("menu-toggle") &&
                $(".deznav .metismenu").height() > window.innerHeight - 60)) &&
            $(".content-body").css(
              "min-height",
              $(".deznav .metismenu").height() + 110 + "px"
            );
        }, 500)),
        setTimeout(() => {
      ...
      $('a[data-action="collapse"]').on("click", function (t) {
        ...
        $('[data-action="reload"]').on("click", function () {
          ...
          t.parents(".card").addClass("card-load"),
            ...
            setTimeout(function () {
              t.parents(".card").children(".card-loader").remove(),
    ...
    T = function () {
      t > 1024 &&
        $(".metismenu  li")
          ...
          .each(function (t) {
            if ($("ul", this).length > 0) {
              var e = $("ul:first", this).css("display", "block"),
                a = e.offset().left,
                n = e.width(),
                e = $("ul:first", this).removeAttr("style");
              $("body").height();
              var s = $("body").width();
              if (jQuery("html").hasClass("rtl")) var i = a + n <= s;
              else var i = a > 0;
              i
            ...
            setTimeout(function () {
              ...
              (t = 0),
                jQuery(".dropzoneContainer").each(function () {
                  (t = jQuery(this).find(".draggable-handle").length),
                    jQuery(this).find(".totalCount").html(t);
                });
            }, 200);
          });
        },
    ...
    A = function () {
      jQuery("#masonry, .masonry").length > 0 &&
        setTimeout(function () {
          jQuery(".filters li").removeClass("active"),
            jQuery(".filters li:first").addClass("active");
          var t = jQuery("#masonry, .masonry"),
            e = $(".filters li:first").attr("data-filter");
          function a(e) {
            t.isotope({ filter: e });
          }
    ...
    D = function () {
      $(".btc-converts").length > 0 &&
        (setTimeout(() => {
          "dark" === $("body").attr("data-theme-version") &&
            $(".btc-converts").attr("dark-mode", !0);
        }, 1e3),
        $("#theme_version").on("change", function () {
          "dark" === $("body").attr("data-theme-version")
            ? $(".btc-converts").attr("dark-mode", !0)
            : $(".btc-converts").attr("dark-mode", !1);
        }));
    },
    I = function () {
    ...
    M = function (t) {
      parseInt($(".header").css("height"), 10),
        $(".navbar-nav .scroll").on("click", function (t) {
          if (
            (t.preventDefault(),
            ...
            var e = parseInt($(this.hash).offset().top, 10),
    ...
    R = function () {
      jQuery(".dz-dropdown").on("click", function () {
        jQuery("#" + jQuery(this).attr("data-dz-dropdown")).hasClass("hidden")
          ? (jQuery(".dz-dropdown-menu").addClass("hidden"),
            jQuery("#" + jQuery(this).attr("data-dz-dropdown")).removeClass(
              "hidden"
            ))
          : jQuery("#" + jQuery(this).attr("data-dz-dropdown")).addClass(
              "hidden"
            );
      }),
        ...
        $(document).on("click", function (t) {
          $(t.target).closest(".dz-dropdown-menu").length > 0 ||
            $(t.target).closest(".dz-dropdown").length > 0 ||
            $(".dz-dropdown-menu").addClass("hidden");
        });
    },
    U = function () {
      jQuery(".dz-popover").on("click", function () {
        jQuery("#" + jQuery(this).attr("data-dz-popover")).hasClass("hide")
          ? (jQuery(".dz-popover-content").fadeOut().addClass("hide"),
            jQuery("#" + jQuery(this).attr("data-dz-popover"))
              .fadeIn()
              .removeClass("hide"))
          : jQuery("#" + jQuery(this).attr("data-dz-popover"))
              .fadeOut()
        ...
        $(document).on("click", function (t) {
          $(t.target).closest(".dz-popover-content").length > 0 ||
            $(t.target).closest(".dz-popover").length > 0 ||
            $(".dz-popover-content").fadeOut().addClass("hide");
        });
    },
    // B = function () {
    //   jQuery(".dz-modal-btn").on("click", function () {
    //     jQuery("#" + jQuery(this).attr("data-dz-modal")).hasClass("model-close")
    //       ? (jQuery(".dz-modal-box").fadeOut("fast").addClass("model-close"),
    //         jQuery("#" + jQuery(this).attr("data-dz-modal")).fadeIn(
    //           "fast",
    //           function () {
    //             $(this).removeClass("model-close");
    //           }
    //         ))
    //       : jQuery("#" + jQuery(this).attr("data-dz-modal"))
    //           .fadeOut("fast")
    //           .addClass("model-close"),
    ...
    L = function () {
      $(".offcanvas-toggle").click(function () {
        $("#" + $(this).attr("data-dz-offcanvas")).hasClass("is-closed")
    ...
    j = function () {
      $(".tab-btn").on("click", function () {
        ...
        $(this)
          .closest(".dz-tab-area")
          .closest_descendent(".nav-tabs,.nav-pills")
          .find(".tab-btn")
          .removeClass("active"),
          $(this)
            .closest(".dz-tab-area")
            .closest_descendent(".tab-content-area")
            .children()
            .removeClass("show"),
          $(this).addClass("active"),
          $(this)
    ...
    G = function () {
      $(".metismenu li a").hover(
        function (t) {
          var e = $(this).parent().children("ul"),
            a = $("#main-wrapper").width(),
            n = ($(window).width() - $("#main-wrapper").width()) / 2;
          $(this).offset().left + $(this).outerWidth() + e.outerWidth() - n >
            a &&
            ($(this).parent().parent("ul.metismenu").length > 0
...
!(function (t) {
  t.fn.closest_descendent = function (e) {
    for (var a = t(), n = this; n.length && !(a = n.filter(e)).length; )
      n = n.children();
    return a.first();
  };
})(jQuery),
