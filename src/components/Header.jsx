          ...
          <nav className="navbar navbar-expand">
            <div className="navbar-collapse justify-between">
              ...
              <ul className="navbar-nav header-right flex flex-row h-full">
                ...
                <li className="nav-item dropdown notification_dropdown flex justify-center relative">
                  <a
                    data-dz-dropdown="DzSettingDropdown"
                    className="dz-dropdown nav-link relative p-[0.8375rem] text-[#464a53] text-lg leading-[1] block duration-500"
                  >
                    <svg
                      width="24"
                      height="24"
                  ...
                  <div
                    id="DzSettingDropdown"
                    className="dz-dropdown-menu absolute z-[9] shadow-[0_0_3.125rem_0_rgba(82,63,105,0.15)] w-[18.5rem] pt-4 mt-0.5 top-full max-md-top-[45px] md:right-0 rounded-md bg-white dark:bg-[#242424] hidden"
                  >
                    <div
                      id="DZ_W_TimeLine02"
                      className="widget-timeline dz-scroll style-1 overflow-y-scroll overflow-x-hidden h-[23.125rem] p-4 relative"
                    >
                      <ul className="timeline relative">
                        <li className="relative mb-[0.9375rem]">
                          <div className="timeline-badge rounded-[50%] h-[1.275rem] absolute top-[0.625rem] w-[1.275rem] bg-white border-[0.125rem] border-primary-light p-1 primary"></div>
                          <a className="timeline-panel text-muted">
                            <span className="text-xs block mb-[0.3125rem] opacity-80 tracking-[0.0625rem]">
                              10 minutes ago
                            </span>
                ...
                <li className="nav-item dropdown notification_dropdown flex justify-center relative">
                  <a
                    data-dz-dropdown="DzNotificationDropdown"
                    className="dz-dropdown nav-link relative p-[0.8375rem] text-[#464a53] text-lg leading-[1] block duration-500"
                    role="button"
                  ...
                  <div
                    id="DzNotificationDropdown"
                    className="dz-dropdown-menu absolute z-[9] shadow-[0_0_3.125rem_0_rgba(82,63,105,0.15)] w-[18.5rem] pt-4 mt-0.5 top-full max-md-top-[45px] md:right-0 rounded-md bg-white dark:bg-[#242424] hidden"
                  >
                    <div
                      id="DZ_W_Notification1"
                      className="widget-media dz-scroll overflow-y-scroll overflow-x-hidden relative p-4"
                      style={{ height: "380px" }}
                    >
                      <ul className="timeline">
                        <li>
                          <div className="timeline-panel flex items-center relative rounded-md py-[0.8rem] px-3 mx-[-5px] duration-500 hover:bg-[#0d99ff0d]">
                            <div className="media flex items-center justify-center w-[2.188rem] h-[2.188rem] bg-[#eee] rounded-full text-[13px] text-center overflow-hidden font-semibold self-start mr-2">
                              <img
                                alt="image"
                                width="50"
                            ...
                            <div className="media-body">
                              <h6 className="mb-1 text-[13px] leading-4">
                                Dr sultads Send you Photo
                              </h6>
                              <small className="block text-bs-dropdown-color">
                        ...
                        <li>
                          <div className="timeline-panel flex items-center relative rounded-md py-[0.8rem] px-3 mx-[-5px] duration-500 hover:bg-[#0d99ff0d]">
                            <div className="media flex items-center justify-center w-[2.188rem] h-[2.188rem] bg-[#eee] rounded-full text-[13px] text-center overflow-hidden font-semibold self-start mr-2 media-info">
                              KG
                            </div>
                            <div className="media-body">
                              <h6 className="mb-1 text-[13px] leading-4">
                        ...
                        <li>
                          <div className="timeline-panel flex items-center relative rounded-md py-[0.8rem] px-3 mx-[-5px] duration-500 hover:bg-[#0d99ff0d]">
                            <div className="media flex items-center justify-center w-[2.188rem] h-[2.188rem] bg-[#eee] rounded-full text-[13px] text-center overflow-hidden font-semibold self-start mr-2 media-success">
                        ...
                        <li>
                          <div className="timeline-panel flex items-center relative rounded-md py-[0.8rem] px-3 mx-[-5px] duration-500 hover:bg-[#0d99ff0d]">
                            <div className="media flex items-center justify-center w-[2.188rem] h-[2.188rem] bg-[#eee] rounded-full text-[13px] text-center overflow-hidden font-semibold self-start mr-2 media-danger">
                              KG
                            </div>
                            <div className="media-body">
                              <h6 className="mb-1 text-[13px] leading-4">
                        ...
                        <li>
                          <div className="timeline-panel flex items-center relative rounded-md py-[0.8rem] px-3 mx-[-5px] duration-500 hover:bg-[#0d99ff0d]">
                            <div className="media flex items-center justify-center w-[2.188rem] h-[2.188rem] bg-[#eee] rounded-full text-[13px] text-center overflow-hidden font-semibold self-start mr-2 media-primary">
                              <i className="fa fa-home"></i>
                            </div>
                            <div className="media-body">
                              <h6 className="mb-1 text-[13px] leading-4">
                    ...
                    <a className="dropdown-item pt-[0.9375rem] px-[1.875rem] pb-[14px] text-center block border-t text-[13px] text-primary border-[#f1f1f1] dark:border-[#444444]">
