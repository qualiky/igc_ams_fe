...
const Card = ({ bgClass, iconClass, title, value, progress, progressText }) => (
  <div className="xl:w-1/4 lg:w-1/2 sm:w-1/2 px-2">
    <div className={`widget-stat card ${bgClass}`}>
      <div className="sm:p-6 p-4">
        <div className="media flex items-center">
          <span className="mr-4 text-white bg-[#ffffff40] w-[5.3125rem] h-[5.3125rem] flex items-center justify-center rounded-full">
          ...
          <div className="media-body text-white flex-1">
            ...
            <h3 className="text-white sm:text-[2.2rem] text-[2.25rem] leading-[1.2]">
              {value}
            </h3>
...
const HomeAnalytics = () => {
  const cardData = [
    {
      bgClass: "bg-primary",
      iconClass: "la la-users text-[4rem]",
      title: "Total Project",
      value: 3280,
      progress: 80,
    ...
    {
      bgClass: "bg-success",
      iconClass: "la la-user text-[4rem]",
      title: "New Students",
      value: 245,
      progress: 50,
