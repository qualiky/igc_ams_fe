...
import { getAllIncomeReceipt } from "../../../selectors/selectors";
import { formatDate } from "../../../const/format-date";
import { Icon } from "@iconify/react/dist/iconify.js";
import TableSkeleton from "../../../components/skeleton/TableSkeleton";

const IncomeTable = () => {
  const { incomeReceipts, isLoading } = useSelector(getAllIncomeReceipt);
        ...
        <div className="xl:w-full">
          <div className="card h-auto">
            <div className="tbl-caption flex justify-between items-center flex-wrap py-4 px-5 relative z-[2] border-b border-[#E6E6E6] dark:border-transparent">
              <h4 className="heading text-xl font-medium">All Income</h4>
                          ...
                          {incomeReceipts?.map((item, index) => (
                            ...
                            >
                              <td
                                ...
                                className="border-b border-[#E6E6E6] dark:border-[#444444] text-[13px]  pl-4 pr-0 font-normal whitespace-nowrap sorting_1"
                              >
                                <span className="text-body-color dark:text-white">
                                  00{item?.id}
                                </span>
                              </td>
                              <td className="border-b border-[#E6E6E6] dark:border-[#444444] text-[13px] px-4 font-normal whitespace-nowrap">
                                <span className="text-body-color dark:text-white">
                              ...
                              <td className="border-b border-[#E6E6E6] dark:border-[#444444] text-[13px] px-4 font-normal whitespace-nowrap text-right">
